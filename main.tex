...
\subsubsection{Outer and Inner approximation of Lebesgue measure}
...
\begin{enumerate}
    ...
    \item There is a $F_{\sigma}$ set F containing E for which $m*(E \sim F) =0$. 
\end{enumerate}
