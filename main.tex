...
We shall build our Lebesgue Measure from the ground up intuitively. While this paper is not a detailed discussion on the topic, we will use known concepts where required to retain the readers' interest.\bigskip
...
The Lebesgue integral opens up many possibilities, many that the Riemann integral cannot. We have seen how the Lebesgue integral is superior when accounting higher dimensions, and the ease in doing so. 
